...
import com.example.whatsappfirebase.databinding.ItemConversasBinding
import com.example.whatsappfirebase.model.Conversa
import com.squareup.picasso.Picasso

class ConversasAdapter(private val onClick: (Conversa) -> Unit) :
    ...
    inner class ConversasViewHolder(private val binding: ItemConversasBinding) :
